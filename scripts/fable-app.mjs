...
const required = [
  ...
  'app/output/fable_modules/Fuaran.UI.Ops.0.78.0/Apply.fs.js',
  'app/output/fable_modules/Fuaran.UI.Ops.0.78.0/JsonDecode.fs.js',
  'app/output/fable_modules/Fuaran.UI.OpStream.Abstractions.0.78.0/CanonicalJson.fs.js',
